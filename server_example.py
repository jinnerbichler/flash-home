...
def main():
    ...
    client_one.settlement(settlementAddresses=settlement_addresses)
    client_two.settlement(settlementAddresses=settlement_addresses)
    ...
    ##########################################################
    client_one.apply(signedBundles=signed_bundl es)
    client_two.apply(signedBundles=signed_bundles)
